...
Attention lors de l'utilisation à bien remplacer tous les *template* par l'id de votre plugin choisi dans le fichier `info.xml`.
...
'''
=== Création plugin partie 2 : plugin_info
